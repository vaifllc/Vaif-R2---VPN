...
class VPNSubscription: NSObject {
    ...
    static let productIdMonthly = "VaifR2VpnMonthly"
    static let productIdAnnual = "VaifR2VpnAnnual"
    static let productIdMonthlyPro = "VaifR2VpnMonthlyPro"
    static let productIdAnnualPro = "VaifR2VpnAnnualPro"
