...
//  VaifVPN
//
//  Created by VAIF on 8/4/22.
//  Copyright © 2022 VAIF LLC. All rights reserved.
//
...
public class LocalizedString {
    ...
    // Human verification
    //public lazy var _su_summary_title = NSLocalizedString("Congratulations", bundle: Bundle.main, comment: "Signup summary title")
    /// Title
    public lazy var _hv_title = NSLocalizedString("Human Verification", bundle: Bundle.main, comment: "Title")

    /// Captcha method name
    public lazy var _hv_captha_method_name = NSLocalizedString("CAPTCHA", bundle: Bundle.main, comment: "captha method name")

    /// sms method name
    public lazy var _hv_sms_method_name = NSLocalizedString("SMS", bundle: Bundle.main, comment: "SMS method name")

    /// email method name
    public lazy var _hv_email_method_name = NSLocalizedString("Email", bundle: Bundle.main, comment: "email method name")

    /// Help button
    public lazy var _hv_help_button = NSLocalizedString("Help", bundle: Bundle.main, comment: "Help button")

    /// OK button
    public lazy var _hv_ok_button = NSLocalizedString("OK", bundle: Bundle.main, comment: "OK button")

    /// Cancel button
    public lazy var _hv_cancel_button = NSLocalizedString("Cancel", bundle: Bundle.main, comment: "Cancel button")

    // Human verification - email method

    /// Email enter label
    public lazy var _hv_email_enter_label = NSLocalizedString("Your email will only be used for this one-time verification.", bundle: Bundle.main, comment: "Enter email label")

    /// Email  label
    public lazy var _hv_email_label = NSLocalizedString("Email", bundle: Bundle.main, comment: "Email label")

    /// Email  verification button
    public lazy var _hv_email_verification_button = NSLocalizedString("Get verification code", bundle: Bundle.main, comment: "Verification button")

    // Human verification - sms method

    /// SMS enter label
    public lazy var _hv_sms_enter_label = NSLocalizedString("Your phone number will only be used for this one-time verification.", bundle: Bundle.main, comment: "Enter SMS label")

    /// SMS  label
    public lazy var _hv_sms_label = NSLocalizedString("Phone number", bundle: Bundle.main, comment: "SMS label")

    /// Search country placeholder
    public lazy var _hv_sms_search_placeholder = NSLocalizedString("Search country", bundle: Bundle.main, comment: "Search country placeholder")

    // Human verification - verification

    /// Verification enter sms code label
    public lazy var _hv_verification_enter_sms_code = NSLocalizedString("Enter the verification code that was sent to %@", bundle: Bundle.main, comment: "Enter sms code label")

    /// Verification enter email code label
    public lazy var _hv_verification_enter_email_code = NSLocalizedString("Enter the verification code that was sent to %@. If you don't find the email in your inbox, please check your spam folder.", bundle: Bundle.main, comment: "Enter email code label")

    /// Verification code label
    public lazy var _hv_verification_code = NSLocalizedString("Verification code", bundle: Bundle.main, comment: "Verification code label")

    /// Verification code hint label
    public lazy var _hv_verification_code_hint = NSLocalizedString("Enter the 6-digit code.", bundle: Bundle.main, comment: "Verification code hint label")

    /// Verification code Verify button
    public lazy var _hv_verification_verify_button = NSLocalizedString("Verify", bundle: Bundle.main, comment: "Verify button")

    /// Verification code Verifying button
    public lazy var _hv_verification_verifying_button = NSLocalizedString("Verifying", bundle: Bundle.main, comment: "Verifying button")

    public lazy var _hv_verification_not_receive_code_button = NSLocalizedString("Did not receive the code?", bundle: Bundle.main, comment: "Not receive code button")

    /// Verification code error alert title
    public lazy var _hv_verification_error_alert_title = NSLocalizedString("Invalid verification code", bundle: Bundle.main, comment: "alert title")

    /// Verification code error alert message
    public lazy var _hv_verification_error_alert_message = NSLocalizedString("Would you like to receive a new verification code or use an alternative verification method?", bundle: Bundle.main, comment: "alert message")

    /// Verification code error alert resend button
    public lazy var _hv_verification_error_alert_resend = NSLocalizedString("Resend", bundle: Bundle.main, comment: "resend alert button")

    /// Verification code error alert try other method button
    public lazy var _hv_verification_error_alert_other_method = NSLocalizedString("Try other method", bundle: Bundle.main, comment: "other method alert button")

    /// Verification new code alert title
    public lazy var _hv_verification_new_alert_title = NSLocalizedString("Request new code?", bundle: Bundle.main, comment: "alert title")

    /// Verification new code alert message
    public lazy var _hv_verification_new_alert_message = NSLocalizedString("Get a replacement code sent to %@.", bundle: Bundle.main, comment: "alert message")

    /// Verification new code alert new code button
    public lazy var _hv_verification_new_alert_button = NSLocalizedString("Request new code", bundle: Bundle.main, comment: "new code alert button")

    /// Verification new code sent banner title
    public lazy var _hv_verification_sent_banner = NSLocalizedString("Code sent to %@", bundle: Bundle.main, comment: "sent baner title")

    // Human verification - help

    /// Verification help header title
    public lazy var _hv_help_header = NSLocalizedString("Need help with human verification?", bundle: Bundle.main, comment: "help header title")

    /// Verification help request item title
    public lazy var _hv_help_request_item_title = NSLocalizedString("Request an invite", bundle: Bundle.main, comment: "request item title")

    /// Verification help request item message
    public lazy var _hv_help_request_item_message = NSLocalizedString("If you are having trouble creating your account, please request an invitation and we will respond within 1 business day.", bundle: Bundle.main, comment: "request item message")

    /// Verification help visit item title
    public lazy var _hv_help_visit_item_title = NSLocalizedString("Visit our Help Center", bundle: Bundle.main, comment: "visit item title")

    /// Verification help visit item message
    public lazy var _hv_help_visit_item_message = NSLocalizedString("Learn more about human verification and why we ask for it.", bundle: Bundle.main, comment: "visit item message")

    // Force upgrade

    /// Force upgrade alert title
    public lazy var _fu_alert_title = NSLocalizedString("Update required", bundle: Bundle.main, comment: "alert title")

    /// Force upgrade alert leran more button
    public lazy var _fu_alert_learn_more_button = NSLocalizedString("Learn more", bundle: Bundle.main, comment: "learn more button")

    /// Force upgrade alert update button
    public lazy var _fu_alert_update_button = NSLocalizedString("Update", bundle: Bundle.main, comment: "update button")

    /// Force upgrade alert quit button
    public lazy var _fu_alert_quit_button = NSLocalizedString("Quit", bundle: Bundle.main, comment: "quit button")

    // Login screen

    /// Login screen title
    public lazy var _ls_screen_title = NSLocalizedString("Sign in", bundle: Bundle.main, comment: "Login screen title")

    /// Login screen subtitle
    public lazy var _ls_screen_subtitle = NSLocalizedString("Enter your R2 Account details.", bundle: Bundle.main, comment: "Login screen subtitle")

    /// Username field title
    public lazy var _ls_username_title = NSLocalizedString("Email", bundle: Bundle.main, comment: "Username field title")

    /// Password field title
    public lazy var _ls_password_title = NSLocalizedString("Password", bundle: Bundle.main, comment: "Password field title")

    /// Help button
    public lazy var _ls_help_button = NSLocalizedString("Need help?", bundle: Bundle.main, comment: "Help button")

    /// Sign in button
    public lazy var _ls_sign_in_button = NSLocalizedString("Sign in", bundle: Bundle.main, comment: "Sign in button")

    /// Sign up button
    public lazy var _ls_create_account_button = NSLocalizedString("Create an account", bundle: Bundle.main, comment: "Create account button")

    // Login welcome screen

    public lazy var _ls_welcome_footer = NSLocalizedString("One account for all R2 services.", bundle: Bundle.main, comment: "Welcome screen footer label")

    // Login help

    /// Login help screen title
    public lazy var _ls_help_screen_title = NSLocalizedString("How can we help?", bundle: Bundle.main, comment: "Login help screen title")

    /// Forgot username help button
    public lazy var _ls_help_forgot_username = NSLocalizedString("Forgot username", bundle: Bundle.main, comment: "Forgot username help button")

    /// Forgot password help button
    public lazy var _ls_help_forgot_password = NSLocalizedString("Forgot password", bundle: Bundle.main, comment: "Forgot password help button")

    /// Other sign-in issues help button
    public lazy var _ls_help_other_issues = NSLocalizedString("Other sign-in issues", bundle: Bundle.main, comment: "Other sign-in issues button")

    /// Customer support help button
    public lazy var _ls_help_customer_support = NSLocalizedString("Customer support", bundle: Bundle.main, comment: "Customer support button")

    /// More help button
    public lazy var _ls_help_more_help = NSLocalizedString("Still need help? Contact us directly.", bundle: Bundle.main, comment: "Customer support button")

    // Login validation

    /// Invalid username hint
    public lazy var _ls_validation_invalid_username = NSLocalizedString("Please enter your R2 Account email or username.", bundle: Bundle.main, comment: "Invalid username hint")

    /// Invalid password hint
    public lazy var _ls_validation_invalid_password = NSLocalizedString("Please enter your R2 Account password.", bundle: Bundle.main, comment: "Invalid password hint")

    // Login errors

    /// Dialog button for missing keys error
    public lazy var _ls_error_missing_keys_text_button = NSLocalizedString("Complete Setup", bundle: Bundle.main, comment: "Dialog button for missing keys error")

    /// Dialog text for missing keys error
    public lazy var _ls_error_missing_keys_text = NSLocalizedString("Your account is missing keys, please sign in on web to automatically generate required keys. Once you have signed in on web, please return to the app and sign in.", bundle: Bundle.main, comment: "Dialog text for missing keys error")

    /// Dialog title for missing keys error
    public lazy var _ls_error_missing_keys_title = NSLocalizedString("Account setup required", bundle: Bundle.main, comment: "Dialog title for missing keys error")

    /// Incorrect mailbox password error
    public lazy var _ls_error_invalid_mailbox_password = NSLocalizedString("Incorrect mailbox password", bundle: Bundle.main, comment: "Incorrect mailbox password error")

    /// Generic error message when no better error can be displayed
    public lazy var _ls_error_generic = NSLocalizedString("An error has occured", bundle: Bundle.main, comment: "Generic error message when no better error can be displayed")

    // Login choose username

    /// Screen title for picking Proton mail username
    public lazy var _ls_username_screen_title = NSLocalizedString("Create ProtonMail address", bundle: Bundle.main, comment: "Screen title for creating Proton Mail address")

    /// Info about existing external Proton Mail address
    public lazy var _ls_username_screen_info = NSLocalizedString("Your Proton Account is associated with %@. To use %@, please create an address.", bundle: Bundle.main, comment: "Info about existing external Proton Mail address")

    /// Username field title
    public lazy var _ls_username_username_title = NSLocalizedString("Username", bundle: Bundle.main, comment: "Username field title")

    /// Action button title for picking Proton Mail username
    public lazy var _ls_username_button_title = NSLocalizedString("Next", bundle: Bundle.main, comment: "Action button title for picking Proton Mail username")

    /// Username field error message
    public lazy var _ls_username_username_error = NSLocalizedString("Please enter a username.", bundle: Bundle.main, comment: "Username field error message")

    // Login create address

    /// Action button title for creating Proton Mail address
    public lazy var _ls_create_address_button_title = NSLocalizedString("Create address", bundle: Bundle.main, comment: "Action button title for creating Proton Mail address")

    /// Info about Proton Mail address usage
    public lazy var _ls_create_address_info = NSLocalizedString("You will use this email address to log into all Proton services.", bundle: Bundle.main, comment: "Info about Proton Mail address usage")

    /// Recovery address label title
    public lazy var _ls_create_address_recovery_title = NSLocalizedString("Your recovery email address:", bundle: Bundle.main, comment: "Recovery address label title")

    /// Terms and conditions note
    public lazy var _ls_create_address_terms_full = NSLocalizedString("By clicking Create address, you agree with Proton's Terms and Conditions.", bundle: Bundle.main, comment: "Terms and conditions note")

    /// Terms and conditions link in the note
    public lazy var _ls_create_address_terms_link = NSLocalizedString("Terms and Conditions", bundle: Bundle.main, comment: "Terms and conditions link in the note")

    /// Proton Mail address availability
    public lazy var _ls_create_address_available = NSLocalizedString("%@ is available", bundle: Bundle.main, comment: "Proton Mail address availability")

    // Login unlock mailbox

    /// Mailbox unlock screen title
    public lazy var _ls_login_mailbox_screen_title = NSLocalizedString("Unlock your mailbox", bundle: Bundle.main, comment: "Mailbox unlock screen title")

    /// Mailbox password field title
    public lazy var _ls_login_mailbox_field_title = NSLocalizedString("Mailbox password", bundle: Bundle.main, comment: "Mailbox password field title")

    /// Mailbox unlock screen action button title
    public lazy var _ls_login_mailbox_button_title = NSLocalizedString("Unlock", bundle: Bundle.main, comment: "Mailbox unlock screen action button title")

    /// Forgot password button title
    public lazy var _ls_login_mailbox_forgot_password = NSLocalizedString("Forgot password", bundle: Bundle.main, comment: "Forgot password button title")

    // Login 2FA

    /// 2FA screen title
    public lazy var _ls_login_2fa_screen_title = NSLocalizedString("Two-factor authentication", bundle: Bundle.main, comment: "2FA screen title")

    /// 2FA screen action button title
    public lazy var _ls_login_2fa_action_button_title = NSLocalizedString("Authenticate", bundle: Bundle.main, comment: "2FA screen action button title")

    /// 2FA screen field title
    public lazy var _ls_login_2fa_field_title = NSLocalizedString("Two-factor code", bundle: Bundle.main, comment: "2FA screen field title")

    /// 2FA screen recovery field title
    public lazy var _ls_login_2fa_recovery_field_title = NSLocalizedString("Recovery code", bundle: Bundle.main, comment: "2FA screen recovery field title")

    /// 2FA screen recovery button title
    public lazy var _ls_login_2fa_recovery_button_title = NSLocalizedString("Use recovery code", bundle: Bundle.main, comment: "2FA screen recovery button title")

    /// 2FA screen 2FA button title
    public lazy var _ls_login_2fa_2fa_button_title = NSLocalizedString("Use two-factor code", bundle: Bundle.main, comment: "2FA screen 2FA button title")

    /// 2FA screen field info
    public lazy var _ls_login_2fa_field_info = NSLocalizedString("Enter the 6-digit code.", bundle: Bundle.main, comment: "2FA screen field info")

    /// 2FA screen recovery field info
    public lazy var _ls_login_2fa_recovery_field_info = NSLocalizedString("Enter an 8-character recovery code.", bundle: Bundle.main, comment: "2FA screen recovery field info")

    // Payments

    public lazy var _error_occured = NSLocalizedString("Error occured", bundle: Bundle.main, comment: "Error alert title")

    /// "OK"
    public lazy var _general_ok_action = NSLocalizedString("OK", bundle: Bundle.main, comment: "Action")

    /// "Warning"
    public lazy var _warning = NSLocalizedString("Warning", bundle: Bundle.main, comment: "Title")

    /// UIAlerts
    public lazy var _do_you_want_to_bypass_validation = NSLocalizedString("Do you want to activate the purchase for %@ address?", bundle: Bundle.main, comment: "Question is user wants to bypass username validation and activate plan for current username")

    public lazy var _yes_bypass_validation = NSLocalizedString("Yes, activate it for ", bundle: Bundle.main, comment: "Warning message option to bypass validation and activate plan for current username")

    public lazy var _no_dont_bypass_validation = NSLocalizedString("No, for another ProtonMail account", bundle: Bundle.main, comment: "Warning message option when user want to relogin to another account")
    ...
    public lazy var _error_apply_payment_on_registration_title = NSLocalizedString("Payment failed", bundle: Bundle.main, comment: "Error applying credit after registration alert")

    public lazy var _error_apply_payment_on_registration_message = NSLocalizedString("You have successfully registered but your payment was not processed. To resend your payment information, click Retry. You will only be charged once. If the problem persists, please contact customer support.", bundle: Bundle.main, comment: "Error applying credit after registration alert")

    public lazy var _retry = NSLocalizedString("Retry", bundle: Bundle.main, comment: "Button in some alerts")

    public lazy var _error_apply_payment_on_registration_support = NSLocalizedString("Contact customer support", bundle: Bundle.main, comment: "Error applying credit after registration alert")

    /// Errors
    public lazy var _error_unavailable_product = NSLocalizedString("Failed to get list of available products from App Store.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_invalid_purchase = NSLocalizedString("Purchase is not possible.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_reciept_lost = NSLocalizedString("Apple informed us you've upgraded the service plan, but some technical data was missing. Please fill in the bug report and our customer support team will contact you.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_another_user_transaction = NSLocalizedString("Apple informed us you've upgraded the service plan, but we detected you have logged out of the account since then.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_backend_mismatch = NSLocalizedString("It wasn't possible to match your purchased App Store product to any products on our server. Please fill in the bug report and our customer support team will contact you.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_sandbox_receipt = NSLocalizedString("Sorry, we cannot process purchases in the beta version of the iOS app. Thank you for participating in our public beta!", bundle: Bundle.main, comment: "Error message for beta users")

    public lazy var _error_no_hashed_username_arrived_in_transaction = NSLocalizedString("We have been notified of an App Store purchase but cannot match the purchase with an account of yours.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_no_active_username_in_user_data_service = NSLocalizedString("Please log in to the ProtonMail account you're upgrading the service plan for so we can complete the purchase.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_transaction_failed_by_unknown_reason = NSLocalizedString("Apple informed us they could not process the purchase.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_no_new_subscription_in_response = NSLocalizedString("We have successfully activated your subscription. Please relaunch the app to start using your new service plan.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_unlock_to_proceed_with_iap = NSLocalizedString("Please unlock the app to proceed with your service plan activation", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_please_sign_in_iap = NSLocalizedString("Please log in to the ProtonMail account you're upgrading the service plan for so we can complete the service plan activation.", bundle: Bundle.main, comment: "Error message")

    public lazy var _error_credits_applied = NSLocalizedString("Contact support@protonvpn.com to complete your purchase.", bundle: Bundle.main, comment: "In App Purchase error")

    public lazy var _error_wrong_token_status = NSLocalizedString("Wrong payment token status. Please relaunch the app. If error persists, contact support.", bundle: Bundle.main, comment: "In App Purchase error")

    //  Login upgrade username-only account

    /// Dialog title for organization user first login
    public lazy var _login_username_org_dialog_title = NSLocalizedString("Change your password", bundle: Bundle.main, comment: "Dialog title for organization user first login")

    /// Dialog action button title for organization user first login
    public lazy var _login_username_org_dialog_action_button = NSLocalizedString("Change password", bundle: Bundle.main, comment: "Dialog action button title for organization user first login")

    /// Dialog message for organization user first login
    public lazy var _login_username_org_dialog_message = NSLocalizedString("To use the Proton app as a member of an organization, you first need to change your password by signing into Proton through a browser.", bundle: Bundle.main, comment: "Dialog message for organization user first login")
    
    /// Account deletion
    
    public lazy var _ad_delete_account_title = NSLocalizedString("Delete account", bundle: Bundle.main, comment: "Delete account screen title")
    
    public lazy var _ad_delete_account_button = NSLocalizedString("Delete account", bundle: Bundle.main, comment: "Delete account button title")
    
    public lazy var _ad_delete_account_message = NSLocalizedString("This will permanently delete your account and all of its data. You will not be able to reactivate this account.", bundle: Bundle.main, comment: "Delete account explaination under button")
    
    public lazy var _ad_delete_account_success = NSLocalizedString("Account deleted.\nLogging out...", bundle: Bundle.main, comment: "Delete account success")
    
    public lazy var _ad_delete_network_error = NSLocalizedString("A networking error has occured", bundle: Bundle.main, comment: "A generic error message when we have no better message from the backend")
    
    public lazy var _ad_delete_close_button = NSLocalizedString("Close", bundle: Bundle.main, comment: "Button title shown when a error has occured, causes the screen to close")

    /// Account switcher

    public lazy var _as_switch_to_title = NSLocalizedString("switch to", bundle: Bundle.main, comment: "Section title of account switcher")

    public lazy var _as_accounts = NSLocalizedString("Accounts", bundle: Bundle.main, comment: "Title of account switcher")

    public lazy var _as_manage_accounts = NSLocalizedString("Manage accounts", bundle: Bundle.main, comment: "Manage accounts button")

    public lazy var _as_signed_in_to_protonmail = NSLocalizedString("Signed in to ProtonMail", bundle: Bundle.main, comment: "Section title of account manager")

    public lazy var _as_signed_out_of_protonmail = NSLocalizedString("Signed out of Protonmail", bundle: Bundle.main, comment: "Section title of account manager")

    public lazy var _as_signout = NSLocalizedString("Sign out", bundle: Bundle.main, comment: "Sign out button/ title")

    public lazy var _as_remove_account = NSLocalizedString("Remove account", bundle: Bundle.main, comment: "remove account button")

    public lazy var _as_remove_account_alert_text = NSLocalizedString("You will be signed out and all the data associated with this account will be removed from this device.", bundle: Bundle.main, comment: "Alert message of remove account")

    public lazy var _as_remove_button = NSLocalizedString("Remove", bundle: Bundle.main, comment: "Remove button")

    public lazy var _as_signout_alert_text = NSLocalizedString("Are you sure you want to sign out %@?", bundle: Bundle.main, comment: "Alert message of sign out the email address")

    public lazy var _as_dismiss_button = NSLocalizedString("Dismiss account switcher", bundle: Bundle.main, comment: "Button for dismissing account switcher")
    
    public lazy var _as_sign_in_button = NSLocalizedString("Sign in to another account", bundle: Bundle.main, comment: "Button for signing into another account")

    // Signup

    /// Signup main view title
    public lazy var _su_main_view_title = NSLocalizedString("Create your R2 Account", bundle: Bundle.main, comment: "Signup main view title")

    /// Signup main view description
    public lazy var _su_main_view_desc = NSLocalizedString("One account for all R2 services.", bundle: Bundle.main, comment: "Signup main view description")

    /// Next button
    public lazy var _su_next_button = NSLocalizedString("Next", bundle: Bundle.main, comment: "Next button")

    /// Sign in button
    public lazy var _su_signin_button = NSLocalizedString("Sign in", bundle: Bundle.main, comment: "Sign in button")

    /// Email address button
    public lazy var _su_email_address_button = NSLocalizedString("Use your current email instead", bundle: Bundle.main, comment: "Email address button")

    /// Proton Mail address  button
    public lazy var _su_proton_address_button = NSLocalizedString("Create a secure ProtonMail address instead", bundle: Bundle.main, comment: "Proton Mail address button")

    /// Username field title
    public lazy var _su_username_field_title = NSLocalizedString("Username", bundle: Bundle.main, comment: "Username field title")

    /// Email field title
    public lazy var _su_email_field_title = NSLocalizedString("Email", bundle: Bundle.main, comment: "Email field title")

    /// Signup password proton view title
    public lazy var _su_password_proton_view_title = NSLocalizedString("Create your password", bundle: Bundle.main, comment: "Signup password proton view title")

    /// Signup password email view title
    public lazy var _su_password_email_view_title = NSLocalizedString("Create a Proton account with your current email", bundle: Bundle.main, comment: "Signup password email view title")

    /// Password field title
    public lazy var _su_password_field_title = NSLocalizedString("Password", bundle: Bundle.main, comment: "Password field title")

    public lazy var _su_password_field_hint = NSLocalizedString("Password must contain at least 8 characters", bundle: Bundle.main, comment: "Password field hint about minimum length")

    /// Repeat password field title
    public lazy var _su_repeat_password_field_title = NSLocalizedString("Repeat password", bundle: Bundle.main, comment: "Repeat password field title")
    
    public lazy var _su_domains_sheet_title = NSLocalizedString("Domain", bundle: Bundle.main, comment: "Title of domains bottom action sheet")
    ...
    public lazy var _su_recovery_view_desc_old = NSLocalizedString("This will help you access your account in case you forget your password or get locked out of your account.", bundle: Bundle.main, comment: "Recovery view description (old string, replaced)")
    ...
    public lazy var _su_recovery_seg_email = NSLocalizedString("Email", bundle: Bundle.main, comment: "Recovery segmenet email")

    /// Signup recovery segmented phone
    public lazy var _su_recovery_seg_phone = NSLocalizedString("Phone", bundle: Bundle.main, comment: "Recovery segmenet phone")

    /// Signup recovery email field title
    public lazy var _su_recovery_email_field_title = NSLocalizedString("Recovery email", bundle: Bundle.main, comment: "Recovery email field title")

    /// Signup recovery phone field title
    public lazy var _su_recovery_phone_field_title = NSLocalizedString("Recovery phone number", bundle: Bundle.main, comment: "Recovery phone field title")

    /// Signup recovery terms and conditions description
    public lazy var _su_recovery_t_c_desc = NSLocalizedString("By clicking Next, you agree with Proton's Terms and Conditions", bundle: Bundle.main, comment: "Recovery terms and conditions description")

    /// Signup recovery terms and conditions link
    public lazy var _su_recovery_t_c_link = NSLocalizedString("Terms and Conditions", bundle: Bundle.main, comment: "Recovery terms and conditions link")

    /// Skip button
    public lazy var _su_skip_button = NSLocalizedString("Skip", bundle: Bundle.main, comment: "Skip button")

    /// Recovery skip title
    public lazy var _su_recovery_skip_title = NSLocalizedString("Skip recovery method?", bundle: Bundle.main, comment: "Recovery skip title")

    /// Recovery skip description
    public lazy var _su_recovery_skip_desc = NSLocalizedString("A recovery method will help you access your account in case you forget your password or get locked out of your account.", bundle: Bundle.main, comment: "Recovery skip description")

    /// Recovery method button
    public lazy var _su_recovery_method_button = NSLocalizedString("Set recovery method", bundle: Bundle.main, comment: "Set recovery method button")

    /// Signup complete view title
    public lazy var _su_complete_view_title = NSLocalizedString("Your account is being created", bundle: Bundle.main, comment: "Complete view title")

    /// Signup complete view description
    public lazy var _su_complete_view_desc = NSLocalizedString("This should take no more than a minute.", bundle: Bundle.main, comment: "Complete view description")

    /// Signup complete progress step creation
    public lazy var _su_complete_step_creation = NSLocalizedString("Creating your account", bundle: Bundle.main, comment: "Signup complete progress step creation")
    
    /// Signup complete progress step address generation
    public lazy var _su_complete_step_address_generation = NSLocalizedString("Generating your address", bundle: Bundle.main, comment: "Signup complete progress step address generation")
    
    /// Signup complete progress step keys generation
    public lazy var _su_complete_step_keys_generation = NSLocalizedString("Securing your account", bundle: Bundle.main, comment: "Signup complete progress step keys generation")
    
    /// Signup complete progress step payment validation
    public lazy var _su_complete_step_payment_verification = NSLocalizedString("Verifying your payment", bundle: Bundle.main, comment: "Signup complete progress step payment verification")
    
    /// Signup complete progress step payment validated
    public lazy var _su_complete_step_payment_validated = NSLocalizedString("Payment validated", bundle: Bundle.main, comment: "Signup complete progress step payment validated")

    /// Signup email verification view title
    public lazy var _su_email_verification_view_title = NSLocalizedString("Account verification", bundle: Bundle.main, comment: "Email verification view title")

    /// Signup email verification view description
    public lazy var _su_email_verification_view_desc = NSLocalizedString("For your security, we must verify that the address you entered belongs to you. We sent a verification code to %@. Please enter the code below:", bundle: Bundle.main, comment: "Email verification view description")

    /// Signup email verification code name
    public lazy var _su_email_verification_code_name = NSLocalizedString("Verification code", bundle: Bundle.main, comment: "Email verification code name")

    /// Signup email verification code description
    public lazy var _su_email_verification_code_desc = NSLocalizedString("Enter the 6-digit code.", bundle: Bundle.main, comment: "Email verification code description")

    /// Did not receive code button
    public lazy var _su_did_not_receive_code_button = NSLocalizedString("Did not receive a code?", bundle: Bundle.main, comment: "Did not receive code button")

    /// Signup terms and conditions view title
    public lazy var _su_terms_conditions_view_title = NSLocalizedString("Terms and Conditions", bundle: Bundle.main, comment: "Terms and conditions view title")

    /// Signup error invalid token request
    public lazy var _su_error_invalid_token_request = NSLocalizedString("Invalid token request", bundle: Bundle.main, comment: "Invalid token request error")

    /// Signup error invalid token
    public lazy var _su_error_invalid_token = NSLocalizedString("Invalid token error", bundle: Bundle.main, comment: "Invalid token error")

    /// Signup error create user failed
    public lazy var _su_error_create_user_failed = NSLocalizedString("Create user failed", bundle: Bundle.main, comment: "Create user failed error")

    /// Signup error invalid hashed password
    public lazy var _su_error_invalid_hashed_password = NSLocalizedString("Invalid hashed password", bundle: Bundle.main, comment: "Invalid hashed password error")

    /// Signup error password empty
    public lazy var _su_error_password_empty = NSLocalizedString("Password can not be empty.\nPlease try again.", bundle: Bundle.main, comment: "Password empty error")

    public lazy var _su_error_password_too_short = NSLocalizedString("Password must contain at least %@ characters.", bundle: Bundle.main, comment: "Password too short error")

    /// Signup error password not equal
    public lazy var _su_error_password_not_equal = NSLocalizedString("Passwords do not match.\nPlease try again.", bundle: Bundle.main, comment: "Password not equal error")

    /// Signup error email address already used
    public lazy var _su_error_email_already_used = NSLocalizedString("Email address already used.", bundle: Bundle.main, comment: "Email address already used error")

    /// Signup invalid verification alert message
    public lazy var _su_invalid_verification_alert_message = NSLocalizedString("Would you like to receive a new verification code or use an alternate email address?", bundle: Bundle.main, comment: "Invalid verification alert message")

    /// Signup invalid verification change email address button
    public lazy var _su_invalid_verification_change_email_button = NSLocalizedString("Change email address", bundle: Bundle.main, comment: "Change email address button")
    
    /// Signup summary title
    public lazy var _su_summary_title = NSLocalizedString("Congratulations", bundle: Bundle.main, comment: "Signup summary title")
    
    /// Signup summary free plan description
    public lazy var _su_summary_free_description = NSLocalizedString("Your Proton Free account was successfully created.", bundle: Bundle.main, comment: "Signup summary free plan description")
    
    /// Signup summary free plan description replacement
    public lazy var _su_summary_free_description_replacement = NSLocalizedString("Proton Free", bundle: Bundle.main, comment: "Signup summary free plan description replacement")
    
    /// Signup summary paid plan description
    public lazy var _su_summary_paid_description = NSLocalizedString("Your payment was confirmed and your %@ account successfully created.", bundle: Bundle.main, comment: "Signup summary paid plan description")
    
    /// Signup summary welcome text
    public lazy var _su_summary_welcome = NSLocalizedString("Enjoy the world of privacy.", bundle: Bundle.main, comment: "Signup summary welcome text")
    
    // Payments UI
    
    /// Select a plan title
    public lazy var _pu_select_plan_title = NSLocalizedString("Select a plan", bundle: Bundle.main, comment: "Plan selection title")

    /// Current plan title
    public lazy var _pu_current_plan_title = NSLocalizedString("Current plan", bundle: Bundle.main, comment: "Plan selection title")
    
    /// Subscription title
    public lazy var _pu_subscription_title = NSLocalizedString("Subscription", bundle: Bundle.main, comment: "Subscription title")
  
    /// Upgrade plan title
    public lazy var _pu_upgrade_plan_title = NSLocalizedString("Upgrade your plan", bundle: Bundle.main, comment: "Plan selection title")
    
    /// Plan footer description
    public lazy var _pu_plan_footer_desc = NSLocalizedString("Only annual subscriptions without auto-renewal are available inside the mobile app.", bundle: Bundle.main, comment: "Plan footer description")

    /// Plan footer description purchased
    public lazy var _pu_plan_footer_desc_purchased = NSLocalizedString("You cannot manage subscriptions inside the mobile application.", bundle: Bundle.main, comment: "Plan footer purchased description")
    
    /// Select plan button
    public lazy var _pu_select_plan_button = NSLocalizedString("Select", bundle: Bundle.main, comment: "Select plan button")
    
    /// Upgrade plan button
    public lazy var _pu_upgrade_plan_button = NSLocalizedString("Upgrade", bundle: Bundle.main, comment: "Upgrade plan button")
   
    /// Plan details renew automatically expired
    public lazy var _pu_plan_details_renew_auto_expired = NSLocalizedString("Your plan will automatically renew on %@", bundle: Bundle.main, comment: "Plan details renew automatically expired")
    
    /// Plan details renew expired
    public lazy var _pu_plan_details_renew_expired = NSLocalizedString("Current plan will expire on %@", bundle: Bundle.main, comment: "Plan details renew expired")

    /// Plan details unavailable contact administrator
    public lazy var _pu_plan_details_plan_details_unavailable_contact_administrator = NSLocalizedString("Contact an administrator to make changes to your Proton subscription.", bundle: Bundle.main, comment: "Plan details unavailable contact administrator")
    
    /// Plan details storage
    public lazy var _pu_plan_details_storage = NSLocalizedString("%@ storage", bundle: Bundle.main, comment: "Plan details storage")

    /// Plan details storage per user
    public lazy var _pu_plan_details_storage_per_user = NSLocalizedString("%@ storage / user", bundle: Bundle.main, comment: "Plan details storage per user")

    /// Plan details medium speed
    public lazy var _pu_plan_details_vpn_free_speed = NSLocalizedString("Medium speed", bundle: Bundle.main, comment: "Plan details medium speed")
    
    /// Plan details custom email addresses
    public lazy var _pu_plan_details_custom_email = NSLocalizedString("Custom email addresses", bundle: Bundle.main, comment: "Plan details custom email addresses")
    
    /// Plan details priority customer support
    public lazy var _pu_plan_details_priority_support = NSLocalizedString("Priority customer support", bundle: Bundle.main, comment: "Plan details priority customer support")
    
    /// Plan details adblocker
    public lazy var _pu_plan_details_adblocker = NSLocalizedString("Adblocker (NetShield)", bundle: Bundle.main, comment: "Plan details adblocker")
    
    /// Plan details adblocker
    public lazy var _pu_plan_details_streaming_service = NSLocalizedString("Streaming service support", bundle: Bundle.main, comment: "Plan details streaming service support")

    /// Plan details n uneven amount of addresses & calendars
    public lazy var _pu_plan_details_n_uneven_amounts_of_addresses_and_calendars = NSLocalizedString("%@ & %@", bundle: Bundle.main, comment: "Plan details n uneven amount of addresses & calendars, like: 1 address & 2 calendars")

    /// Plan details high speed message
    public lazy var _pu_plan_details_high_speed = NSLocalizedString("High speed", bundle: Bundle.main, comment: "Plan details high speed message")

    /// Plan details highest speed message
    public lazy var _pu_plan_details_highest_speed = NSLocalizedString("Highest speed", bundle: Bundle.main, comment: "Plan details highest speed message")

    /// Plan details high speed message
    public lazy var _pu_plan_details_multi_user_support = NSLocalizedString("Multi-user support", bundle: Bundle.main, comment: "Plan details multi-user support message")
    
    /// Plan details free description
    public lazy var _pu_plan_details_free_description = NSLocalizedString("The basic for private and secure communications.", bundle: Bundle.main, comment: "Plan details free description")
    
    /// Plan details plus description
    public lazy var _pu_plan_details_plus_description = NSLocalizedString("Full-featured mailbox with advanced protection.", bundle: Bundle.main, comment: "Plan details plus description")
    
    /// Plan details plus description
    public lazy var _pu_plan_details_pro_description = NSLocalizedString("ProtonMail for professionals and businesses", bundle: Bundle.main, comment: "Plan details pro description")
    
    /// Plan details visionary description
    public lazy var _pu_plan_details_visionary_description = NSLocalizedString("Mail + VPN bundle for families and small businesses", bundle: Bundle.main, comment: "Plan details visionary description")
    
    /// Unfinished operation error dialog title
    public lazy var _pu_plan_unfinished_error_title = NSLocalizedString("Complete payment?", bundle: Bundle.main, comment: "Unfinished operation error dialog title")
    
    /// Unfinished operation error dialog description
    public lazy var _pu_plan_unfinished_error_desc = NSLocalizedString("A purchase for a Proton Bundle plan has already been initiated. Press continue to complete the payment processing and create your account", bundle: Bundle.main, comment: "Unfinished operation error dialog description")
    
    /// Unfinished operation error dialog retry button
    public lazy var _pu_plan_unfinished_error_retry_button = NSLocalizedString("Complete payment", bundle: Bundle.main, comment: "Unfinished operation error dialog retry button")
    
    /// Unfinished operation dialog description
    public lazy var _pu_plan_unfinished_desc = NSLocalizedString("The account setup process could not be finalized due to an unexpected error.\nPlease try again.", bundle: Bundle.main, comment: "Unfinished operation dialog description")
    
    // IAP in progress banner message
    public lazy var _pu_iap_in_progress_banner = NSLocalizedString("The IAP purchase process has started. Please follow Apple's instructions to either complete or cancel the purchase.", bundle: Bundle.main, comment: "IAP in progress banner message")

// Splash

    /// Part of "Made by Proton" text at the bottom of the splash screen
    public lazy var _splash_made_by = NSLocalizedString("Made by", bundle: Bundle.main, comment: "Made by")

// Networking

    /// Networking connection error
    public lazy var _net_connection_error = NSLocalizedString("Network connection error", bundle: Bundle.main, comment: "Networking connection error")
    
    /// Networking connection error
    public lazy var _net_insecure_connection_error = NSLocalizedString("The TLS certificate validation failed when trying to connect to the Proton API. Your current Internet connection may be monitored. To keep your data secure, we are preventing the app from accessing the Proton API.\nTo log in or access your account, switch to a new network and try to connect again.", bundle: Bundle.main, comment: "Networking insecure connection error")
    ...
    /// From %@ Server:
    public static func fromServerTitle(_ p1: Any) -> String {
      return LocalizedString.tr("Localizable", "_from_server_title", String(describing: p1))
    }
    /// General
    ...
    /// Kill Switch is protecting your IP\n\nYour internet connection will resume as soon as Proton VPN reconnects to a server. To resume without VPN protection, disable Kill Switch.
    ...
    /// Basic Locations
    public static var locationsBasic: String { return LocalizedString.tr("Localizable", "_locations_basic") }
    /// Plus Locations
    public static var locationsBasicPlus: String { return LocalizedString.tr("Localizable", "_locations_basic_plus") }
    /// Free Locations
    ...
    public static func maximumDeviceDescription(_ p1: Any, _ p2: Int) -> String {
      return LocalizedString.tr("Localizable", "_maximum_device_description", String(describing: p1), p2)
    }
    ...
    public static var moneyBackGuarantee: String { return LocalizedString.tr("Localizable", "_money_back_guarantee") }
    /// More info
    ...
    /// Use Secure Core, stream your favorite TV shows,\nuse on up to 5 different devices and more!
    public static var plusUpgradeDescription: String { return LocalizedString.tr("Localizable", "_plus_upgrade_description") }
    /// Enjoying Proton VPN?\nGet Plus for only $8/mo
    public static var plusUpgradeTitle: String { return LocalizedString.tr("Localizable", "_plus_upgrade_title") }
    /// Preferences
    ...
    /// Your purchase was successful. Your Proton VPN Basic plan is now active.
    public static var setupCompleteBasic: String { return LocalizedString.tr("Localizable", "_setup_complete_basic") }
    ...
    public static func subscriptionUpgradeOption1(_ p1: Any) -> String {
      return LocalizedString.tr("Localizable", "_subscription_upgrade_option1", String(describing: p1))
    }
    /// Connect up to %@ devices at the same time
    public static func subscriptionUpgradeOption2(_ p1: Any) -> String {
      return LocalizedString.tr("Localizable", "_subscription_upgrade_option2", String(describing: p1))
    }
    ...
    /// Begin configuration
    public static var sysexWizardButton: String { return LocalizedString.tr("Localizable", "_sysex_wizard_button") }
    /// Click on "Begin configuration". Two dialogs will appear, then click on "Open Security Preferences".\nAlternatively, click here to open the same settings.
    ...
    /// Click on "Begin configuration". Dialog will appear, then click on "Open Security Preferences".\nAlternatively, click here to open the same settings.
    ...
    /// Basic
    public static var tierBasic: String { return LocalizedString.tr("Localizable", "_tier_basic") }
    /// Free
    ...
    /// To %@ Server:
    public static func toServerTitle(_ p1: Any) -> String {
      return LocalizedString.tr("Localizable", "_to_server_title", String(describing: p1))
    }
    /// TOR
