...
//    private let connectionStatusService: ConnectionStatusService
    ...
    init(cityName: String, translatedCityName: String?, countryModel: CountryModel, servers: [ServerItemViewModel], alertService: AlertService /*8vpnGateway: VpnGatewayProtocol?,*/ /*connectionStatusService: ConnectionStatusService*/) {
